...
interface PathingStrategy {
    /*Returns a prefix of a path from the start point to a point within reach of the end point.
    This path is only valid ("clear") when returned, but may be invalidated by movement of other entities.
